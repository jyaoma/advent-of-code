...
const ranking   = ['A','K','Q','J','T','9','8','7','6','5','4','3','2'];
...
lines.forEach(line => {
    ...
    if (counts.includes(5)) value += FIVE_KIND;
    else if (counts.includes(4)) value += FOUR_KIND;
    else if (counts.includes(3) && counts.includes(2)) value += FULL_HOUSE;
    else if (counts.includes(3)) value += THREE_KIND;
    else if (counts.sort((a, b) => b - a)[1] === 2) value += TWO_PAIR;
    else if (counts.includes(2)) value += ONE_PAIR;
